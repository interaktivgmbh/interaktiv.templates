from interaktiv.templates.services.templatescontainer.get import (
    InteraktivTemplatesContainerGet,
)
...
class TestTemplatesContainerGet(TestCase):
    ...
    def test_template_container_get__containers_result(self):
        ...
        self.assertEqual(
            result.get("containers")[0].get("id"), self.template_container.getId()
        )
        self.assertEqual(
            result.get("containers")[0].get("path"), "/plone/templates_container"
        )
    ...
    def test_template_container_get__nearest_container(self):
        ...
        # post condition
        self.assertEqual(
            result.get("nearest_container"), self.template_container.absolute_url()
        )
