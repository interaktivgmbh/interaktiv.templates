...
class TestHelper(TestCase):
    ...
    def test_no_request_returns_same_schema(self):
        ...
        # do it
        with patch(
            "interaktiv.templates.utilities.helper.getRequest", return_value=None
        ):
    ...
    def test_no_blocks_layout_in_properties_returns_same_schema(self):
        ...
        # do it
        with patch(
            "interaktiv.templates.utilities.helper.getRequest",
    ...
    def test_template_blocks_missing_returns_same_schema(self):
        ...
        with (
            ...
            patch(
                "interaktiv.templates.utilities.helper.uuidToObject",
    ...
    def test_schema_updated_with_template_blocks(self):
        ...
        with (
            ...
            patch(
                "interaktiv.templates.utilities.helper.uuid4",
                side_effect=["new-block-id"],
            ),
        ):
            result = get_schema_from_template(schema)
        ...
        expected_schema = {
            "properties": {
                "blocks": {"default": {"new-block-id": {"type": "text"}}},
                "blocks_layout": {"default": {"items": ["new-block-id"]}},
            }
        }
