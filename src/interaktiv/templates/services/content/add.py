...
class InteraktivTemplateFolderPost(Service):
    ...
    def reply(self):
        ...
        # INTERAKTIV START
        is_template_thumbnail = data.get("thumbnailUpload", False)
        # INTERAKTIV END
        ...
        # INTERAKTIV START
        if is_template_thumbnail:
            setattr(obj, "thumbnailUpload", is_template_thumbnail)
        # INTERAKTIV END
